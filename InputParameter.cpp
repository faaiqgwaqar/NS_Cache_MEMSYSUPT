...
InputParameter::InputParameter() {
	...
	maxNumActiveMatPerRow = 1;//maxNumColumnMat;
	minNumActiveMatPerColumn = 1;
	maxNumActiveMatPerColumn = 1;//maxNumRowMat;
	minNumRowSubarray = 4;
	maxNumRowSubarray = 4;
	minNumColumnSubarray = 4;
	maxNumColumnSubarray = 4;
	minNumActiveSubarrayPerRow = 4;
	maxNumActiveSubarrayPerRow = maxNumColumnSubarray;
	minNumActiveSubarrayPerColumn = 4;
